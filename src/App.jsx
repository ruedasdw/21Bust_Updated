...
function BrandMark() {
  ...
  return (
    <div className="flex items-center gap-3 min-w-0">
      {imgOk ? (
        <img src={MASTER_LOGO} alt="" aria-hidden="true" onError={() => setImgOk(false)} className="h-10 w-auto max-w-[150px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.15)]" />
      ) : (
